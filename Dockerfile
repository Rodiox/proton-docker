...
RUN git clone https://github.com/ProtonProtocol/proton.contracts.git /home/gitpod/proton.contracts && cd /home/gitpod/proton.contracts && git checkout v1.9.1-7 && git submodule update --init --recursive && rm -r build && mkdir build && cd /home/gitpod/proton.contracts/build && cmake -GNinja .. && ninja && mkdir /home/gitpod/contracts && cp `find . -name '*.wasm'` /home/gitpod/contracts && cd /home/gitpod && sudo chown gitpod /home/gitpod/contracts && sudo chgrp gitpod /home/gitpod/contracts && rm -rf /home/gitpod/proton.contracts
